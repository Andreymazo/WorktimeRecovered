...
from worktime.views import CustomUserList, CustomLoginView, CustomuserCreateWithDoubleForm, EmployeeCreateWithDoublform\
    , EmployeeDetail, EmployerDetail, EmployerFilteredListView,FilteredCustomUserListView, EmploeeTableView, TimesheetsDeleteView, TimesheetsDetailView\
        ,  TimesheetsFilteredFilterView, TimesheetLst, EmployeeDelete, TimesheetsCreateView, TimesheetsUpdateView, WorkTimeListView,\
              WorkTimeCreateView, WorkTimeUpdateView, WorkTimeDetailView, WorktimeDeleteView
